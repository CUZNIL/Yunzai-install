        ...
        "menu_data": [
            {
                ...
                "detail_des": (
                    ...
                    "Bot 管理员可以通过在此指令后紧跟2334556789 或"
                    "附带 @某人 的方式将 UID 100123456 绑定至指定的 QQ。指令示例：\n"
            ...
            },
            {
                ...
                "detail_des": (
                    "查找雷电将军、九条裟罗、枫原万叶、班尼特组成的队伍伤害。注意角色名之间必须使用空格分开。含有 旅"
                    "行者 的配队暂时无法查询。队伍角色只要使用 面板 指令查询过或者正在展柜中摆放即可配队（即所有查询"
                    "过的角色都有缓存，使用 面板 指令查看所有可用的角色）。\n"
